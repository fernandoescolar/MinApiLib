...
public record Handler() : GetHandlerAsync<Request>("/breweries")
{
    ...
    protected override async Task<IResult> HandleAsync(Request req, CancellationToken cancellationToken = default)
    {
